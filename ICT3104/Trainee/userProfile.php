...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            <?php include 'traineeSideNavbar.php' ?>

            <div class="main-panel">
                <?php include 'traineeNavbar.php' ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control border-input" placeholder="Cancel Limit" disabled value="<?php echo $cancelLimit; ?>" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="form-group"> 
                                                        <label>Subscription Plan</label>
                                                        <select name="ddlSubscriptionPlan" id="ddlSubscriptionPlan" class="form-control border-input">
